...
<?php
$projets = json_decode(file_get_contents('http://localhost:8888/API_PHP/controllers/lireactifyear.php'));
...
if (isset($_POST['projets_id'])) {
    ...
    $data = array('id_ay' => $projetID);
    $result = CallAPI('DELETE', "deleteactifyear.php", $data);
    header('location: ./VuePhp.php');
    ...
    <table class="table" name="table">
        ...
        <tbody>
          <tr>
            ...
            <td>
            <?php
                        echo ' <form action="./VuePhp.php" method="POST"><input type="hidden"
                          name="codeL" value=' . $projet->id_ay . ' >
