...
<br><br>
<?php
$projets = json_decode(file_get_contents('http://localhost:8888/api_php/controllers/lirenote.php'));
...
if (isset($_POST['projets_id'])) {
    ...
    $data = array('id_note' => $projetID);
    $result = CallAPI('DELETE', "deletenote.php", $data);
    header('location: ./vuenote.php');
    ...
    <table class="table" name="table">
        ...
        <tbody>
          <tr>
            ...
            <td><?= $projet -> id_note ?></td>
            <td><?= $projet -> id_module?></td>
            <td><?= $projet -> noteTD ?></td>
            <td><?= $projet -> noteTP ?></td>
            <td><?= $projet -> noteEXAM ?></td>
            <td><?= $projet -> noteRTPG ?></td>
            <td><?= $projet -> id_ay ?></td>
            <td>
            <?php
                        echo ' <form action="./vuenote.php" method="POST"><input type="hidden"
                          name="codeL" value=' . $projet->id_note . ' >
